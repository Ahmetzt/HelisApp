...
<script>
    ...
    export default {
        ...
        computed: {
            logoutClass() {
                return {
                    'd-none': !this.$store.getters.isAuthenticated || this.$store.getters.isResultPage
                }
            }
        },
    }
...
<style lang="scss">
    ...
    .mytable2 tr:last-child {
        border-top: 1px solid #d5d7e7;
        border-top-width: 1px;
        border-top-style: solid;
        border-top-color: rgb(213, 215, 231);
    }
